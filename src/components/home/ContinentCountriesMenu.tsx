        ...
        <div className="flex justify-center items-center py-4">
          <div className="flex space-x-1">
            {Object.entries(continentData).map(([continent, continentInfo]) => (
              <div key={continent} className="group relative">
                <button 
                ...
                {/* Mega Menu Dropdown */}
                <div className="absolute top-full left-0 mt-2 w-[1200px] bg-white shadow-2xl border rounded-lg overflow-visible opacity-0 invisible group-hover:opacity-100 group-hover:visible transition-all duration-300 z-[100]">
                  <div className="flex">
                    {/* Countries Column */}
