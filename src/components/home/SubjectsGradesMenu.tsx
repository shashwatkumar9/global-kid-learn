...
const allGrades = [
  ...
  { title: "High School (9-12)", href: "/grades/9-12", description: "Advanced topics and exam preparation.", category: "Secondary Education" },
  { title: "GCSE (9-11)", href: "/grades/gcse", description: "General Certificate of Secondary Education.", category: "UK Qualifications" },
  { title: "A-Levels (12-13)", href: "/grades/a-levels", description: "Advanced level qualifications.", category: "UK Qualifications" },
  { title: "IB Programme (11-12)", href: "/grades/ib", description: "International Baccalaureate curriculum.", category: "International Programs" },
  { title: "AP Courses (9-12)", href: "/grades/ap", description: "Advanced Placement for US students.", category: "US Programs" },
  { title: "University Prep", href: "/grades/university-prep", description: "Preparation for higher education.", category: "Pre-University" },
];
...
const gradesByCategory = allGrades.reduce((acc, grade) => {
        ...
        <NavigationMenuList>
          <NavigationMenuItem>
            ...
            <NavigationMenuContent className="z-50">
              <div className="w-[800px] p-6 bg-white shadow-xl border">
                <div className="grid grid-cols-3 gap-6">
                  {Object.entries(gradesByCategory).map(([category, grades]) => (
                    <div key={category} className="flex flex-col">
                      <h3 className="font-bold text-base mb-3 text-blue-600 border-b border-gray-200 pb-2">
                        {category}
                      </h3>
